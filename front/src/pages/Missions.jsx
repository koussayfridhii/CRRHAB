      ...
      <Text textAlign="justify" color={"text"} fontSize="xl" mb={2}>
        ...
        >
          ...
          recherche, adoptée par l’IRESA :`
            : language === "en"
            ? `The missions of the Regional Research Center on Horticulture and Organic Agriculture (CRRHAB) are part of the regionalization and decentralization strategy for research adopted by the IRESA:`
      ...
      <Text textAlign="justify" color={"text"} fontSize="xl" mb={2}>
        ...
        >
          {language === "fr"
            ...
            : language === "en"
            ? `In addition, the CRRHAB is highly involved in training through research, through internships, supervision of doctoral theses, and postdoctoral training for young scientists and students.`
